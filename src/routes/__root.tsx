...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Ciplostem — Stem Cell Therapy for Knee OA" },
      { property: "og:description", content: "DCGI-approved off-the-shelf stem cell therapy for knee osteoarthritis." },
